...
func TestChannelMonitoringRouteUsesReadPermission(t *testing.T) {
	assertChannelRoutePermission(t, http.MethodGet, "/monitoring/:id", authz.ChannelRead, controller.GetChannelMonitoring)
}
