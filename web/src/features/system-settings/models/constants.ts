...
export const IFLYTEK_PRESET_ID = -102
export const IFLYTEK_PRESET_NAME = '讯飞星辰 MaaS 价格预设'
export const IFLYTEK_PRESET_BASE_URL = 'https://in.iflyaicloud.com'
export const IFLYTEK_PRESET_ENDPOINT =
  '/api/v1/gpt-finetune/model/base/list-v2?page=1&size=9999&sort=0'
